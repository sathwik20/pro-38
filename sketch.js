...
function setup() {
  ...
  trex = createSprite(camera.x+windowWidth-1000,windowHeight-200,20,50);
...
trex.velocityX=0.1
  ...
  gameOver = createSprite(windowWidth/2,height/2- 50);
  gameOver.addImage(gameOverImg);
  
  restart = createSprite(windowWidth/2,height/2);
